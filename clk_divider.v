...
//El clock divider nos ayudará a estabilizar un poco la forma en la que 
//vemos el botón. Un botón es un componente mecánico, por lo que al ser presionado 
//oscilará entre 0 y 1 antes de estabilizarse (bounce). 
//menor frecuencia = mayor tolerancia al bounce (sólo detectamos estados estables)
